...
const badgeVariants = cva(
  "h-5 gap-1 corner-shape rounded-full border border-transparent px-1 text-xs font-medium transition-all duration-200 [&>svg]:size-3! inline-flex items-center justify-center w-fit whitespace-nowrap shrink-0 [&>svg]:pointer-events-none aria-disabled:cursor-not-allowed aria-disabled:opacity-50 overflow-hidden group/badge",
  {
    variants: {
      variant: {
