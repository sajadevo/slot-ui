...
const inputVariants = cva(
  "placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground border-input w-full min-w-0 rounded-md border bg-transparent text-base shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 text-sm [corner-shape:var(--shape)] focus-visible:ring-ring/50 focus-visible:ring-3 focus-visible:border-ring",
  {
    variants: {
      size: {
        default: "h-10 px-3",
