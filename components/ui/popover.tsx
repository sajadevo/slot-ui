    ...
    <PopoverPortal>
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-foreground origin-(--transform-origin) rounded-lg border p-4 shadow-xs transition-all duration-500 data-ending-style:scale-90 data-ending-style:opacity-0 data-starting-style:scale-90 data-starting-style:opacity-0",
            className,
          )}
          {...props}
        >
